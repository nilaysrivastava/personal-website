    ...
    <footer>
      ...
      <div className="hidden xxl:flex fixed bottom-[160px] -left-[100px] rotate-90">
        <div className="flex items-center gap-3 text-purple-500 cursor-pointer">
          <a href="https://www.linkedin.com/in/nilay-srivastava-29939a205/"><FaLinkedin size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://github.com/nilaysrivastava"><FaGithub size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
          <a href="https://www.instagram.com/nilaysriivastava/"><FaInstagram size={30} className='duration-100 -rotate-90 hover:scale-110' /></a>
